...
public class CustomerAddressController {
    ...
    public ResponseEntity<ApiResponse<CustomerAddressDTO>> createAddress(
            @Parameter(description = "Customer ID", required = true, example = "1") @PathVariable Long customerId,
    ...
    public ResponseEntity<ApiResponse<CustomerAddressDTO>> getAddressById(
            @Parameter(description = "Customer ID", required = true, example = "1") @PathVariable Long customerId,
            @Parameter(description = "Address ID", required = true, example = "1") @PathVariable Long addressId) {
